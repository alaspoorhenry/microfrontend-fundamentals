...
const app = {
  ...
  async mount(props) {
    ...
    const parentToAppend = document.getElementById("single-spa-application:vanilla-app");
    parentToAppend.appendChild(image);
  },
  // Required
  async unmount(props) {
    console.log("App is unmounting", props);
    const parentToClear = document.getElementById("single-spa-application:vanilla-app");
